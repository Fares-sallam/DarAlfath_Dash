                            ...
                            <div className="mt-3 grid grid-cols-1 md:grid-cols-[1fr_1fr_2fr] gap-3">
                              ...
                              {v.variant_type === 'مادي' ? (
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                  ...
                                  <div className="bg-white rounded-xl p-3">
                                    <label className="text-xs text-gray-500 block mb-1" title="هذا الوزن يحدد سعر الشحن الفعلي حسب المحافظة (أسعار الشحن). عدد الخانات العشرية لا يهم — 0.32 و0.320 نفس القيمة بالظبط ويُحسبان بنفس الطريقة.">
                                      الوزن (كجم)
                                    </label>
                                    <input
                                      type="number"
                                      ...
                                      className="input-field text-sm py-1.5 h-auto px-2 text-center"
                                      placeholder="0.3"
                                      title="هذا الوزن يحدد سعر الشحن الفعلي حسب المحافظة (أسعار الشحن). عدد الخانات العشرية لا يهم — 0.32 و0.320 نفس القيمة بالظبط ويُحسبان بنفس الطريقة."
                                    />
                                  </div>
                                </div>
                              ) : (
